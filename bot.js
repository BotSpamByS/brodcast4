...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Server : TopexMC`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Development By  : HmDo#9998 ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`Bbc |Development By : HmDo`,"http://twitch.tv/Death Shop")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/8DXPfPu
            **`);
